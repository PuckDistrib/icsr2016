...
interface BubbleSort{
	public void bubbleSort(int[] numbers, SortingContext ctxt);
}
...
interface LinearSort{
	public void linearSort(int[] numbers, SortingContext ctxt);
}

class LinearSortImpl implements LinearSort{
	public void linearSort(int[] numbers, SortingContext ctxt) {
...
class SortingContext { 
   ...
   public SortingContext(int algo, int[] numbers)	{
	...
	public void sort(int algo, int[] numbers) {
		if (algo == 0){
			LinearSort ls = new LinearSortImpl();
			ls.linearSort(numbers, this);
		}
		else {
			BubbleSort bs = new BubbleSortImpl();
			bs.bubbleSort(numbers, this);
		}
		}
}
