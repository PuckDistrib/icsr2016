...
class ButtonAction extends Button {
	...
	public ButtonAction(String label, Action act) {
		super(label, act);
	}
...
class ButtonAction2 extends Button {
	...
	public ButtonAction2(String label, Action act) {
		super(label, act);
	}
}
...
public class Main {
	...
	public static void main(String[] args) {  
    	...
    	Button button1 = new ButtonAction("Print Date", new Action1());
    	Button button2 = new ButtonAction2("Command 1", new Action2());
    	Button button3 = new ButtonAction("Command 2", new Action1()); 
